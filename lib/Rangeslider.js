  ...
  function Slider(props, context) {
    ...
    _this.handleKeyDown = function (e) {
      ...
      switch (keyCode) {
        case 38:
        case 39:
          _this.props.reverse && keyCode === 39 ? dec() : inc();
          onChange && onChange(sliderValue, e);
          e.preventDefault();
          break;
        case 37:
        case 40:
          _this.props.reverse && keyCode === 37 ? inc() : dec();
          onChange && onChange(sliderValue, e);
          e.preventDefault();
          break;
      }
...
Slider.propTypes = {
  ...
  'aria-invalid': _propTypes2.default.bool,
  'aria-describedby': _propTypes2.default.bool,
